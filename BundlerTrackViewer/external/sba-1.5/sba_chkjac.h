...
extern void sba_motstr_chkjac_grid_x(
	  void (*func)(double *p, struct sba_crsm *idxij, int *rcidxs, int *rcsubs, double *hx, void *adata),
	  void (*jacf)(double *p, int n, int nvis, int no_grids, struct sba_crsm *idxij, int *rcidxs, int *rcsubs, double *jac, void *adata),
...
extern void sba_str_chkjac_x_grid(
	  void (*func)(double *p, struct sba_crsm *idxij, int *rcidxs, int *rcsubs, double *hx, void *adata),
