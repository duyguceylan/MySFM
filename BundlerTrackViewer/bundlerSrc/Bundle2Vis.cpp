...
class Bundle2Vis
{
	static void ReadBundleFile(const char *bundle_file, 
	...
	static void WriteVisFile(const char *vis_file, 
                  std::vector<camera_params_t> &cameras,
	...
	static void convertBundleToVis(char *bundle_file, char *vis_file) 
	{
