...
#include "imagelib/canny.h"
#include "imagelib/defines.h"
#include "imagelib/filter.h"
#include "imagelib/fit.h"
#include "matrix/matrix.h"
#include "imagelib/pgm.h"
...
void ImageData::InitFromString(char *buf, char *path, bool fisheye_by_default) 
{
    ...
    m_fisheye = fisheye;
    m_has_init_focal = true;//has_init_focal;
	//synth: 1562.304810
	//uclPub/uclBld2: 2945.455
	//columbus2: 3225.806
	//istanbul1/2:2636.883
	//ny5:3507.954
	//ny7/vienna3:4207.792
	//library:6618.1811
	//palace:2209.09
	//opera/vienna7:4207.292
	//vienna5:6545.454
	//soho:3225.806
	//lausanne1: 2510.314
	//lausanne2:2929.238
	//lausanne4-5-6-8:2441.031
	//ucl3:2209.091
	//ucl1,2,4,5:3289.091
	//ucl8: 2945.455
	//ist2: 1648.052
	//ucl5, lowRes:822.273
	//ucl9, lowRes:736.364
    m_init_focal = 2945.455;//2209.091;//3289.091;//3077.074;//2945.455;//822.273;//2209.091;//3289.091;//3225.806;//1493.0;//700.0;//1765.52;//1562.304810;//2945.455;//1944.887;
